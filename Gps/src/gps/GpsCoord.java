...
public class GpsCoord {
	 ...
	 * @param east
	 */
	GpsCoord(int latitudeDegree, int latitudeMinute, double latitudeSecond, int longitudeDegree, int longitudeMinute, double longitudeSecond, boolean north, boolean east){
